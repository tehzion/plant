/*
  ...
  1. New Tables
    ...
    - `assessment_progress`: Tracks completion status per section
    
  2. Changes
    - Add question type and configuration to assessment_questions
    - Update assessment_responses to handle different response types
    
  3. Security
    - Enable RLS on new tables
    - Add policies for question options and progress tracking
*/
