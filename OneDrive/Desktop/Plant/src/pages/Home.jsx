...
import { Camera, ShoppingBag, BookOpen, Clock, Droplets, Globe, Bug, FlaskConical, CloudSun, MapPin, Sun, CloudRain, Snowflake, CloudLightning, CheckCircle, AlertTriangle, Leaf, Sprout, ScanLine, AlertCircle, Info } from 'lucide-react';
      ...
      <div className="dashboard page fade-in">
        <div className="container">
          ...
          <div className="services-grid mt-md">
            ...
            <button onClick={() => navigate('/guide')} className="action-tile secondary-tile bounce-in delay-300 guide-tile">
